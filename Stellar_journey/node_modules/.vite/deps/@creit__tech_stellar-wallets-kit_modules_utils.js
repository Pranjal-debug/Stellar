...
var require_index_min = __commonJS({
  "node_modules/@creit.tech/stellar-wallets-kit/node_modules/@stellar/freighter-api/build/index.min.js"(exports, module) {
    !(function(r3, e2) {
      ...
      s2.r(t2), s2.d(t2, { WatchWalletChanges: () => u, addToken: () => S, default: () => D, getAddress: () => _2, getNetwork: () => C, getNetworkDetails: () => O, isAllowed: () => R, isBrowser: () => U, isConnected: () => N, requestAccess: () => w2, setAllowed: () => I, signAuthEntry: () => l, signMessage: () => c, signTransaction: () => d }), (function(r4) {
      ...
      const n2 = (r4) => {
        ...
        if (U) {
          ...
          const o2 = await (async (r5, s4, t4) => {
            ...
            const T2 = (t4 || {}).address;
            try {
              o3 = await n2({ blob: r5, accountToSign: T2, apiVersion: "6.0.0", networkPassphrase: null == t4 ? void 0 : t4.networkPassphrase, type: e2.SUBMIT_BLOB });
            } catch (r6) {
        ...
        if (U) {
          ...
          const o2 = await (async (r5, s4, t4) => {
            ...
            let T2;
            try {
              T2 = await n2({ entryXdr: r5, accountToSign: o3, apiVersion: "6.0.0", networkPassphrase: null == t4 ? void 0 : t4.networkPassphrase, type: e2.SUBMIT_AUTH_ENTRY });
            } catch (r6) {
      ...
      const U = "undefined" != typeof window, D = { getAddress: _2, addToken: S, signTransaction: d, signMessage: c, signAuthEntry: l, isConnected: N, getNetwork: C, getNetworkDetails: O, isAllowed: R, setAllowed: I, requestAccess: w2, WatchWalletChanges: u };
      return t2;
    })());
  }
});
...
var require_index_min2 = __commonJS({
  "node_modules/@lobstrco/signer-extension-api/build/index.min.js"(exports, module) {
    !(function(e2, n2) {
      ...
      "use strict";
      var e2 = { d: (n3, o2) => {
        for (var t3 in o2) e2.o(o2, t3) && !e2.o(n3, t3) && Object.defineProperty(n3, t3, { enumerable: true, get: o2[t3] });
      }, o: (e3, n3) => Object.prototype.hasOwnProperty.call(e3, n3), r: (e3) => {
        "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e3, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(e3, "__esModule", { value: true });
      } }, n2 = {};
      e2.r(n2), e2.d(n2, { default: () => u, getPublicKey: () => a, isBrowser: () => S, isConnected: () => c, signMessage: () => l, signTransaction: () => d });
      let o = (function(e3) {
        return e3[e3.V1 = 0] = "V1", e3[e3.V2 = 1] = "V2", e3;
      })({}), t2 = (function(e3) {
        return e3.REQUEST_ACCESS = "REQUEST_ACCESS", e3.SIGN = "SIGN", e3.SUBMIT_TRANSACTION = "SUBMIT_TRANSACTION", e3.SIGN_TRANSACTION = "SIGN_TRANSACTION", e3.REQUEST_CONNECTION_STATUS = "REQUEST_CONNECTION_STATUS", e3;
      })({});
      const r3 = "LOBSTR_CONNECTION_KEY", i2 = (e3) => {
        const n3 = Date.now() + Math.random();
        return window.postMessage({ source: "LOBSTR_EXTERNAL_MSG_REQUEST", messageId: n3, ...e3 }, window.location.origin), new Promise((o2) => {
          let r4 = 0;
          e3.type === t2.REQUEST_CONNECTION_STATUS && (r4 = setTimeout(() => {
            o2({ isConnected: false }), window.removeEventListener("message", i3);
          }, 2e3));
          const i3 = (e4) => {
            var t3, s3;
            e4.source === window && "LOBSTR_EXTERNAL_MSG_RESPONSE" === (null == e4 || null === (t3 = e4.data) || void 0 === t3 ? void 0 : t3.source) && (null == e4 || null === (s3 = e4.data) || void 0 === s3 ? void 0 : s3.messagedId) === n3 && (o2(e4.data), window.removeEventListener("message", i3), clearTimeout(r4));
          };
          window.addEventListener("message", i3, false);
        });
      }, s2 = async (e3, n3, r4) => {
        let s3 = { signedData: "", error: "", signerAddress: "" };
        try {
          s3 = await i2({ dataToSign: e3, connectionKey: n3, signType: r4, type: t2.SIGN, version: o.V2 });
        } catch (e4) {
        ...
        if (!S) return "";
        const { publicKey: e3, connectionKey: n3 } = await (async () => {
          let e4 = { publicKey: "", error: "", connectionKey: "" };
          try {
            e4 = await i2({ type: t2.REQUEST_ACCESS, version: o.V2 });
          } catch (e5) {
            console.error(e5);
          }
          const { publicKey: n4, connectionKey: r4, error: s3 } = e4;
          if (s3) throw s3;
          return { publicKey: n4, connectionKey: r4 };
        })();
        return ((e4) => {
          var n4, o2;
          null === (n4 = window) || void 0 === n4 || null === (o2 = n4.sessionStorage) || void 0 === o2 || o2.setItem(r3, e4);
        })(n3), e3;
      }, d = async (e3) => {
        if (!S) return Promise.resolve("");
        const n3 = (null === (o2 = window) || void 0 === o2 || null === (t3 = o2.sessionStorage) || void 0 === t3 ? void 0 : t3.getItem(r3)) || "";
        var o2, t3;
        return (await s2(e3, n3, "transaction")).signedData;
      }, c = async () => !!S && (window.lobstrSignerExtension ? window.lobstrSignerExtension : await (async () => {
        let e3 = { isConnected: false };
        try {
          e3 = await i2({ type: t2.REQUEST_CONNECTION_STATUS, version: o.V2 });
        } catch (e4) {
          console.error(e4);
        }
        ...
        const n3 = (null === (o2 = window) || void 0 === o2 || null === (t3 = o2.sessionStorage) || void 0 === t3 ? void 0 : t3.getItem(r3)) || "";
        var o2, t3;
        const i3 = await s2(e3, n3, "message");
        return { signedMessage: i3.signedData, signerAddress: i3.signerAddress };
      }, S = "undefined" != typeof window, u = { getPublicKey: a, signTransaction: d, isConnected: c, signMessage: l };
      return n2;
    })());
  }
});
...
alphabet.base32.forEach((byte, i2) => rAlphabet.base32[byte] = i2);
alphabet.base32hex.forEach((byte, i2) => rAlphabet.base32hex[byte] = i2);
alphabet.base32crockford.forEach((byte, i2) => rAlphabet.base32crockford[byte] = i2);
...
function detach(buffer2, maxSize) {
  ...
  return [buffer2, maxSize - originalSize];
}
...
function encode2(buffer2, i2, o, alphabet8, padding6) {
  i2 += 2;
  for (; i2 < buffer2.length; i2 += 3) {
    const x = buffer2[i2 - 2] << 16 | buffer2[i2 - 1] << 8 | buffer2[i2];
    buffer2[o++] = alphabet8[x >> 18];
    buffer2[o++] = alphabet8[x >> 12 & 63];
    buffer2[o++] = alphabet8[x >> 6 & 63];
    buffer2[o++] = alphabet8[x & 63];
  }
  switch (i2) {
    case buffer2.length + 1: {
      const x = buffer2[i2 - 2] << 16;
      buffer2[o++] = alphabet8[x >> 18];
      buffer2[o++] = alphabet8[x >> 12 & 63];
      buffer2[o++] = padding6;
      buffer2[o++] = padding6;
    ...
    case buffer2.length: {
      const x = buffer2[i2 - 2] << 16 | buffer2[i2 - 1] << 8;
      buffer2[o++] = alphabet8[x >> 18];
      buffer2[o++] = alphabet8[x >> 12 & 63];
      buffer2[o++] = alphabet8[x >> 6 & 63];
      buffer2[o++] = padding6;
...
function encodeBase64(data) {
  ...
  encode2(output, i2, 0, alphabet4, padding4);
...
alphabet5.forEach((byte, i2) => rAlphabet5[byte] = i2);
...
alphabet6.forEach((byte, i2) => rAlphabet6[byte] = i2);
new TextEncoder().encode("ABCDEF").forEach((byte, i2) => rAlphabet6[byte] = i2 + 10);
...
alphabet7.forEach((byte, i2) => rAlphabet7[byte] = i2);
new TextEncoder().encode("ABCDEF").forEach((byte, i2) => rAlphabet7[byte] = i2 + 10);
...
var w = class {
  constructor(o) {
    ...
    const d = import_tweetnacl.box.keyPair(), u = (0, import_tweetnacl_util.encodeBase64)((0, import_tweetnacl.randomBytes)(24));
    this.encryptForReceiver = (r3) => {
      const n2 = (0, import_tweetnacl.randomBytes)(24), o2 = (0, import_tweetnacl.box)((0, import_tweetnacl_util.decodeUTF8)(r3.data), n2, r3.receiverPublicKey, d.secretKey);
      ...
      const t2 = import_tweetnacl.box.open((0, import_tweetnacl_util.decodeBase64)(s2.payload), (0, import_tweetnacl_util.decodeBase64)(s2.oneTimeCode), (0, import_tweetnacl_util.decodeBase64)(s2.senderPublicKey), d.secretKey);
...
// node_modules/@creit.tech/stellar-wallets-kit/esm/sdk/modules/fordefi.module.js
var FREIGHTER_EXTERNAL_MSG_REQUEST = "FREIGHTER_EXTERNAL_MSG_REQUEST";
var FREIGHTER_EXTERNAL_MSG_RESPONSE = "FREIGHTER_EXTERNAL_MSG_RESPONSE";
...
var FORDEFI_ID = "fordefi";
var FordefiModule = class {
  constructor() {
    Object.defineProperty(this, "moduleType", {
      enumerable: true,
      configurable: true,
  ...
  async isAvailable() {
    return typeof window !== "undefined" && !!window.FordefiProviders?.StellarProvider;
  }
  async getAddress() {
    try {
      await this.runChecks();
...
// node_modules/@creit.tech/stellar-wallets-kit/esm/sdk/modules/cactuslink.module.js
var CACTUSLINK_ID = "cactuslink";
var CactusLinkModule = class {
  constructor() {
    Object.defineProperty(this, "moduleType", {
      enumerable: true,
      configurable: true,
...
// node_modules/@creit.tech/stellar-wallets-kit/esm/sdk/modules/dcent.module.js
var DCENT_ID = "dcent";
var DCENT_AVAILABILITY_WAIT_MS = 800;
var DcentModule = class {
  constructor() {
    Object.defineProperty(this, "moduleType", {
      enumerable: true,
      configurable: true,
  ...
  async isAvailable() {
    ...
    const appeared = await new Promise((resolve) => {
      const timer2 = setTimeout(() => resolve(false), DCENT_AVAILABILITY_WAIT_MS);
      const onReady = () => {
        clearTimeout(timer2);
        resolve(true);
      };
  ...
  async connected() {
    try {
      const { isConnected: isConnected3 } = await this.getProvider().isConnected();
      return isConnected3;
    } catch (e2) {
      console.error(e2);
      return false;
  ...
  async getAddress(params) {
    try {
      ...
      if (params?.skipRequestAccess !== true) {
        await provider.requestAccess().catch(() => void 0);
      }
...
//# sourceMappingURL=@creit__tech_stellar-wallets-kit_modules_utils.js.map
