...
var n = function(t3, s, r2, e) {
  ...
  for (var h2 = 1; h2 < s.length; h2++) {
    var p = s[h2++], a2 = s[h2] ? (s[0] |= p ? 1 : 2, r2[s[h2++]]) : s[++h2];
    3 === p ? e[0] = a2 : 4 === p ? e[1] = Object.assign(e[1] || {}, a2) : 5 === p ? (e[1] = e[1] || {})[s[++h2]] = a2 : 6 === p ? e[1][s[++h2]] += a2 + "" : p ? (u = t3.apply(a2, n(t3, a2, r2, ["", null])), e.push(u), a2[0] ? s[0] |= 2 : (s[h2 - 2] = 0, s[h2] = u)) : e.push(a2);
  }
  return e;
};
...
function htm_module_default(s) {
  ...
  return r2 || (r2 = /* @__PURE__ */ new Map(), t.set(this, r2)), (r2 = n(this, r2.get(s) || (r2.set(s, r2 = (function(n2) {
    for (var t3, s2, r3 = 1, e = "", u = "", h2 = [0], p = function(n3) {
      ...
      a2 && (1 === r3 && p(), p(a2));
      for (var l = 0; l < n2[a2].length; l++) t3 = n2[a2][l], 1 === r3 ? "<" === t3 ? (p(), h2 = [h2], r3 = 3) : e += t3 : 4 === r3 ? "--" === e && ">" === t3 ? (r3 = 1, e = "") : e = t3 + e[0] : u ? t3 === u ? u = "" : e += t3 : '"' === t3 || "'" === t3 ? u = t3 : ">" === t3 ? (p(), r3 = 1) : r3 && ("=" === t3 ? (r3 = 5, s2 = e, e = "") : "/" === t3 && (r3 < 5 || ">" === n2[a2][l + 1]) ? (p(), 3 === r3 && (h2 = h2[0]), r3 = h2, (h2 = h2[0]).push(2, 0, r3), r3 = 0) : " " === t3 || "	" === t3 || "\n" === t3 || "\r" === t3 ? (p(), r3 = 2) : e += t3), 3 === r3 && "!--" === e && (r3 = 4, h2 = h2[0]);
    }
    return p(), h2;
...
function hash(value) {
  for (var h2 = 9, index = value.length; index--; ) h2 = Math.imul(h2 ^ value.charCodeAt(index), 1597334677);
  return "#" + ((h2 ^ h2 >>> 9) >>> 0).toString(36);
}
...
function merge(rules2, name) {
  ...
  for (let rule18 of rules2)
    if (rule18.d && rule18.n) {
      if (current?.p == rule18.p && "" + current.r == "" + rule18.r) {
        current.c = [
          current.c,
          rule18.c
        ].filter(Boolean).join(" ");
...
var kAutocomplete = /* @__PURE__ */ Symbol("@twind/autocomplete");
...
function twind(userConfig, sheet) {
  let config2 = defineConfig(userConfig), context = (function({ theme: theme3, darkMode, darkColor = noop, variants: variants2, rules: rules2, hash: hash$1, stringify, ignorelist, finalize }) {
    ...
    let h2 = "function" == typeof hash$1 ? (value) => hash$1(value, hash) : hash$1 ? hash : identity;
    h2 !== identity && finalize.push((rule18) => ({
      ...rule18,
      n: rule18.n && h2(rule18.n),
      d: rule18.d?.replace(/--(tw(?:-[\w-]+)?)\b/g, (_, property) => "--" + h2(property).replace("#", ""))
    }));
    let ctx = {
...
var rules = [
  ...
  matchTheme("animate(?:$|-)", "animation", (match2, { theme: theme3, h: h2, e }) => {
    let animation3 = join(match2), parts = animation3.split(" "), keyframeValues = theme3("keyframes", parts[0]);
    return keyframeValues ? {
      ["@keyframes " + (parts[0] = e(h2(parts[0])))]: keyframeValues,
...
var variants = [
  ...
  [
    "((group|peer)(~[^-[]+)?)(-\\[(.+)]|[-[].+?)(\\/.+)?",
    withAutocomplete(({ 2: type, 3: name = "", 4: $4, 5: $5 = "", 6: label = name }, { e, h: h2, v }) => {
      let selector = normalize($5) || ("[" == $4[0] ? $4 : v($4.slice(1)));
      return `${(selector.includes("&") ? selector : "&" + selector).replace(/&/g, `:merge(.${e(h2(type + label))})`)}${"p" == type[0] ? "~" : " "}&`;
...
//# sourceMappingURL=@creit__tech_stellar-wallets-kit_sdk.js.map
