...
function L(n3, l5, u4, t4, i4, r4, o4, e4, f4, c4, a4) {
  var s4, h5, p5, v4, y5, _4, g4, m4 = t4 && t4.__k || w, b4 = l5.length;
  for (f4 = T(u4, l5, m4, f4, b4), s4 = 0; s4 < b4; s4++) null != (p5 = u4.__k[s4]) && (h5 = -1 != p5.__i && m4[p5.__i] || d, p5.__i = s4, _4 = q(n3, p5, h5, i4, r4, o4, e4, f4, c4, a4), v4 = p5.__e, p5.ref && h5.ref != p5.ref && (h5.ref && J(h5.ref, null, p5), a4.push(p5.ref, p5.__c || v4, p5)), null == y5 && null != v4 && (y5 = v4), (g4 = !!(4 & p5.__u)) || h5.__k === p5.__k ? (f4 = j(p5, f4, n3, g4), g4 && h5.__e && (h5.__e = null)) : "function" == typeof p5.type && void 0 !== _4 ? f4 = _4 : v4 && (f4 = v4.nextSibling), p5.__u &= -7);
  return u4.__e = y5, f4;
}
...
function q(n3, u4, t4, i4, r4, o4, e4, f4, c4, a4) {
  var s4, h5, p5, v4, y5, d5, _4, k3, x4, M, $2, I2, P2, A3, H2, T4, j4 = u4.type;
  if (void 0 !== u4.constructor) return null;
  128 & t4.__u && (c4 = !!(32 & t4.__u), o4 = [f4 = u4.__e = t4.__e]), (s4 = l.__b) && s4(u4);
  n: if ("function" == typeof j4) {
    h5 = e4.length;
    try {
      if (x4 = u4.props, M = j4.prototype && j4.prototype.render, $2 = (s4 = j4.contextType) && i4[s4.__c], I2 = s4 ? $2 ? $2.props.value : s4.__ : i4, t4.__c ? k3 = (p5 = u4.__c = t4.__c).__ = p5.__E : (M ? u4.__c = p5 = new j4(x4, I2) : (u4.__c = p5 = new C(x4, I2), p5.constructor = j4, p5.render = Q), $2 && $2.sub(p5), p5.state || (p5.state = {}), p5.__n = i4, v4 = p5.__d = true, p5.__h = [], p5._sb = []), M && null == p5.__s && (p5.__s = p5.state), M && null != j4.getDerivedStateFromProps && (p5.__s == p5.state && (p5.__s = m({}, p5.__s)), m(p5.__s, j4.getDerivedStateFromProps(x4, p5.__s))), y5 = p5.props, d5 = p5.state, p5.__v = u4, v4) M && null == j4.getDerivedStateFromProps && null != p5.componentWillMount && p5.componentWillMount(), M && null != p5.componentDidMount && p5.__h.push(p5.componentDidMount);
      else {
        if (M && null == j4.getDerivedStateFromProps && x4 !== y5 && null != p5.componentWillReceiveProps && p5.componentWillReceiveProps(x4, I2), u4.__v == t4.__v || !p5.__e && null != p5.shouldComponentUpdate && false === p5.shouldComponentUpdate(x4, p5.__s, I2)) {
        ...
        null != p5.componentWillUpdate && p5.componentWillUpdate(x4, p5.__s, I2), M && null != p5.componentDidUpdate && p5.__h.push(function() {
          p5.componentDidUpdate(y5, d5, _4);
        });
      }
      if (p5.context = I2, p5.props = x4, p5.__P = n3, p5.__e = false, P2 = l.__r, A3 = 0, M) p5.state = p5.__s, p5.__d = false, P2 && P2(u4), s4 = p5.render(p5.props, p5.state, p5.context), w.push.apply(p5.__h, p5._sb), p5._sb = [];
      else do {
        p5.__d = false, P2 && P2(u4), s4 = p5.render(p5.props, p5.state, p5.context), p5.state = p5.__s;
      } while (p5.__d && ++A3 < 25);
      p5.state = p5.__s, null != p5.getChildContext && (i4 = m(m({}, i4), p5.getChildContext())), M && !v4 && null != p5.getSnapshotBeforeUpdate && (_4 = p5.getSnapshotBeforeUpdate(y5, d5)), H2 = null != s4 && s4.type === S && null == s4.key ? E(s4.props.children) : s4, f4 = L(n3, g(H2) ? H2 : [H2], u4, t4, i4, r4, o4, e4, f4, c4, a4), p5.base = u4.__e, u4.__u &= -161, p5.__h.length && e4.push(p5), k3 && (p5.__E = p5.__ = null);
    } catch (n4) {
      if (e4.length = h5, u4.__v = null, c4 || null != o4) if (n4.then) {
      ...
      else u4.__e = t4.__e, !u4.__k && t4.__k && (u4.__k = t4.__k), n4.then || B(u4);
      l.__e(n4, u4, t4);
    }
...
function G(u4, t4, i4, r4, o4, e4, f4, c4, a4) {
  var s4, h5, p5, v4, y5, w5, _4, m4 = i4.props || d, k3 = t4.props, x4 = t4.type;
  ...
  if (null == x4) m4 === k3 || c4 && u4.data == k3 || (u4.data = k3);
    ...
    if (e4 = "textarea" == x4 && null != k3.defaultValue ? null : e4 && n.call(u4.childNodes), !c4 && null != e4) for (m4 = {}, s4 = 0; s4 < u4.attributes.length; s4++) m4[(y5 = u4.attributes[s4]).name] = y5.value;
    for (s4 in m4) y5 = m4[s4], "dangerouslySetInnerHTML" == s4 ? p5 = y5 : "children" == s4 || s4 in k3 || "value" == s4 && "defaultValue" in k3 || "checked" == s4 && "defaultChecked" in k3 || N(u4, s4, null, y5, o4);
    for (s4 in k3) y5 = k3[s4], "children" == s4 ? v4 = y5 : "dangerouslySetInnerHTML" == s4 ? h5 = y5 : "value" == s4 ? w5 = y5 : "checked" == s4 ? _4 = y5 : c4 && "function" != typeof y5 || m4[s4] === y5 || N(u4, s4, y5, m4[s4], o4);
    ...
    c4 && "textarea" != x4 || (s4 = "value", "progress" == x4 && null == w5 ? u4.removeAttribute("value") : null != w5 && (w5 !== u4[s4] || "progress" == x4 && !w5 || "option" == x4 && w5 != m4[s4]) && N(u4, s4, w5, m4[s4], o4), s4 = "checked", null != _4 && _4 != u4[s4] && N(u4, s4, _4, m4[s4], o4));
  }
  return u4;
}
function J(n3, u4, t4) {
...
function R(u4, t4, i4) {
  var r4, o4, e4, f4;
  t4 == document && (t4 = document.documentElement), l.__ && l.__(u4, t4), o4 = (r4 = "function" == typeof i4) ? null : i4 && i4.__k || t4.__k, e4 = [], f4 = [], q(t4, u4 = (!r4 && i4 || t4).__k = k(S, null, [u4]), o4 || d, d, t4.namespaceURI, !r4 && i4 ? [i4] : o4 ? null : t4.firstChild ? n.call(t4.childNodes) : null, e4, !r4 && i4 ? i4 : o4 ? o4.__e : t4.firstChild, r4, f4), D(e4, u4, f4), u4.props.children = null;
}
...
function parseError(e4) {
  return {
    code: e4?.error?.code || e4?.code || -1,
    message: e4?.error?.message || e4?.message || typeof e4 === "string" && e4 || "Unhandled error from the wallet",
    ext: e4?.error?.ext || e4?.ext
  };
}
function disconnect() {
...
//# sourceMappingURL=chunk-EPBUINP7.js.map
