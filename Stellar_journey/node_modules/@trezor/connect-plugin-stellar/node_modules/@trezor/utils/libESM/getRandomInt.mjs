export const getRandomInt = (min, max) => {
  ...
  if (typeof globalThis.crypto?.getRandomValues !== 'function') {
    throw new Error('Web Crypto API (globalThis.crypto.getRandomValues) is not available in this environment. ' + 'Requires a secure browser context (HTTPS) or Node.js 19+.');
  }
