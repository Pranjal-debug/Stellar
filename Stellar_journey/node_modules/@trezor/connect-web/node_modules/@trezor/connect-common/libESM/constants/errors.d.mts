...
export declare const ERROR_CODES: {
    ...
    readonly Method_DataOverflowModelOne: "Model One does not support data over 1024 bytes";
...
export declare const serializeError: (payload: any) => SerializedError;
