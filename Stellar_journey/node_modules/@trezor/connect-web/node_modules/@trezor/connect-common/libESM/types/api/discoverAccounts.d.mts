import type { BlockchainLinkParams } from '../../_vendor_blockchain_link.mjs';
import { MessagesSchema as PROTO } from '@trezor/protobuf';
import type { AccountInfo } from '../account.mjs';
import type { EntropyCheckResult } from '../device.mjs';
...
export declare const ACCOUNT_TYPES: readonly [{
    ...
    readonly symbol: "trx";
    readonly type: "normal";
    readonly path: "m/44'/195'/0'/0/i";
}, {
    readonly symbol: "trx";
    readonly type: "ledger";
    readonly path: "m/44'/195'/i'/0/0";
}, {
    readonly symbol: "ttrx";
    readonly type: "normal";
    readonly path: "m/44'/195'/0'/0/i";
}, {
    readonly symbol: "ttrx";
...
export type AdditionalParams = Pick<BlockchainLinkParams<'getAccountInfo'>, 'details' | 'pageSize' | 'protocols' | 'gap'> & {
    identity?: string;
};
