...
export const TronContracts = Type.Union([TronTransferContract, TronTriggerSmartContract, TronFreezeBalanceV2Contract, TronUnfreezeBalanceV2Contract, TronWithdrawExpireUnfreezeContract, TronVoteWitnessContract]);
...
export const TronContractInput = Type.Union([TronTransferContract, TronTriggerSmartContract, TronFreezeBalanceV2ContractInput, TronUnfreezeBalanceV2ContractInput, TronWithdrawExpireUnfreezeContract, TronVoteWitnessContractInput]);
export const TronSignTransaction = Type.Object({
  ...
  contract: Type.Array(TronContractInput, {
    length: 1
  })
});
