...
import type { Descriptor } from '../_vendor_transport.mjs';
import type { Branded } from '@trezor/type-utils';
import type { FirmwareCapability, FirmwareReleaseConfigInfo } from './firmware.mjs';
...
export type UnavailableCapabilities = Partial<Record<FirmwareCapability | (string & {}), UnavailableCapability>>;
...
export type EntropyCheckResult = {
    success: boolean;
    xpubHashes?: XPubHashesPerBip43Path;
};
