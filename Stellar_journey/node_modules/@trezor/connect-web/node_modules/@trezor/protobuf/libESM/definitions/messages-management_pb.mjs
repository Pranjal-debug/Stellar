...
export const RecoveryDevice_RecoveryDeviceInputMethodSchema = enumDesc(file_messages_management, 30, 0);
export const RecoveryDevice_RecoveryDeviceInputMethod = tsEnum(RecoveryDevice_RecoveryDeviceInputMethodSchema);
