import { type ThpCredentials, type ThpDeviceProperties, type ThpHandshakeCredentials, type ThpMessageSyncBit, ThpPairingMethod } from './messages';
...
export declare class ThpState {
    ...
    private _piggybackAckAvailable;
    private _piggybackAckEnabled;
    private _recentMessage;
    get recentMessage(): Buffer<ArrayBufferLike>;
    setRecentMessage(msg: Buffer): void;
    ...
    get isPiggybackAckAvailable(): boolean;
    enablePiggybackAck(enabled: boolean): void;
    get isPiggybackAckEnabled(): boolean;
    resetState(): void;
    toString(): string;
}
