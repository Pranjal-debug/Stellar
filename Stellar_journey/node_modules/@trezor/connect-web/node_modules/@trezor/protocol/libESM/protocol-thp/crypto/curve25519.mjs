import { littleEndianBytesToBigInt } from "./tools.mjs";
let constants;
const getConstants = () => {
  if (constants) {
    return constants;
...
export function curve25519(privateKey, publicKey) {
...
export function elligator2(point) {
  const ctx = getConstants();
  const {
    p,
    J,
...
export const getCurve25519KeyPair = randomBytes => {
