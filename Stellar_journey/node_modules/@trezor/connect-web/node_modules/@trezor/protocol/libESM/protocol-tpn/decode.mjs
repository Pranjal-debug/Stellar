import { PROTOCOL_MALFORMED, PROTOCOL_MISSMATCH_VERSION } from "../errors.mjs";
import { MESSAGE_LENGTH, TPN_VERSION } from "./constants.mjs";
export var Version;
(function (Version) {
  Version[Version["v1"] = 1] = "v1";
})(Version || (Version = {}));
export var TrezorPushNotificationType;
...
})(TrezorPushNotificationType || (TrezorPushNotificationType = {}));
export var TrezorPushNotificationMode;
...
})(TrezorPushNotificationMode || (TrezorPushNotificationMode = {}));
export const decode = message => {
  ...
  if (message.length < MESSAGE_LENGTH || !Object.values(Version).includes(version) || !Object.values(TrezorPushNotificationType).includes(type) || !Object.values(TrezorPushNotificationMode).includes(mode)) {
    return {
      success: false,
