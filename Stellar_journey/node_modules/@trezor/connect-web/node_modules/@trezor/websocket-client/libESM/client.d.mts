...
export declare class WebsocketClient<Events extends Record<string, any>> extends TypedEmitter<Events & WebsocketClientEvents> {
    ...
    protected readonly messages: import("@trezor/utils").DeferredManager<any, number>;
    ...
    private onError;
    sendMessage(message: WebsocketRequest, { timeout, onIdCreated }?: WebsocketSendParams): Promise<any>;
